...
def test_nx_wgs_to_utm():
    ...
    for _s, _e, d in G_utm_30.edges(data=True):
...
def test_nx_from_generic_geopandas(primal_graph):
    ...
    total_lens_input = 0
    for _s, _e, d in primal_graph.edges(data=True):
