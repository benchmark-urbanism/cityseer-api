...
IF TESTING: twine upload --repository-url https://test.pypi.org/legacy/ dist/*
TEST WITH: pip install --extra-index-url https://test.pypi.org/simple/ cityseer==0.7.6rc7
