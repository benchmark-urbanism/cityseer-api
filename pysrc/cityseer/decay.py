...
directly to the `decay_fn` parameter of [`centrality_shortest`](/metrics/networks#centrality-shortest),
[`compute_stats`](/metrics/layers#compute-stats),
[`compute_accessibilities`](/metrics/layers#compute-accessibilities), and other analysis functions.
