...
(generated by sampling/sampling_reach.py) and updates the constants in config.py.
...
CONSTANTS_FILE = SCRIPT_DIR / "sampling" / "output" / "sampling_model_constants.json"
...
def main():
    ...
    if not CONSTANTS_FILE.exists():
        ...
        print("Run sampling/sampling_reach.py first to generate the model constants.")
    ...
    # Note: config.py uses SHORTEST prefix for actual values; short names are aliases
    updates = [
        # Metric-specific rho models (shortest path)
        ("SAMPLING_MODEL_SHORTEST_HARMONIC_A", harmonic_a),
        ("SAMPLING_MODEL_SHORTEST_HARMONIC_B", harmonic_b),
        ("SAMPLING_MODEL_SHORTEST_BETWEENNESS_A", betweenness_a),
        ("SAMPLING_MODEL_SHORTEST_BETWEENNESS_B", betweenness_b),
        # Std and bias models (shortest path)
        ("SAMPLING_MODEL_SHORTEST_STD_C", std_c),
        ("SAMPLING_MODEL_SHORTEST_STD_D", std_d),
        ("SAMPLING_MODEL_SHORTEST_BIAS_E", bias_e),
        ("SAMPLING_MODEL_SHORTEST_BIAS_F", bias_f),
    ]
