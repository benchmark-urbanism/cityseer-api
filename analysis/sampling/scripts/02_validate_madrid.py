...
Usage:
    ...
    python 02_validate_madrid.py --force   # Force regeneration of validation data
...
def load_madrid_network(force: bool = False):
    ...
    if madrid_cache.exists() and not force:
        ...
        # Guard: the province road-mask must lie within the available data (mask and edges both EPSG:25830)
        assert_mask_within_data(madrid_buffered, edges_gdf, "Madrid")
...
def main():
    ...
    print("=" * 70)
    print("02_validate_madrid.py - External validation on Madrid network")
    print("=" * 70)
