...
seven NC counties intersecting Cary + 20 km. Fetch with fetch_tiger_cary.py first.
...
# Cary TIGER/Line EDGES directory (per-county zips from fetch_tiger_cary.py)
