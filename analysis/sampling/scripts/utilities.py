...
# Hoeffding defaults come from cityseer.sampling (single source of truth), so macros
# generated by the analysis scripts cannot drift from the runtime defaults. The
# import-as-same-name form marks an intentional re-export.
from cityseer.sampling import HOEFFDING_DELTA as HOEFFDING_DELTA
from cityseer.sampling import HOEFFDING_EPSILON as HOEFFDING_EPSILON
