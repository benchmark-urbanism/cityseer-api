...
| [gpd_mixed_uses](/examples/accessibility/gpd-mixed-uses) | Mixed land-uses with [`layers.compute_mixed_uses`](/metrics/layers#compute_mixed_uses). |
